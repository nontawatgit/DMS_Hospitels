...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="text-center mb-4">
                        <font size="8" style="color:black">ข้อมูลผู้ใช้</font><br>
                    </div>
                    ...
                    <div class="card shadow mb-4 ">
                        <div class="card-header py-1">
                            <div class="py-2 d-flex flex-row align-items-center justify-content-between">
                                ...
                                <button type="button" class="btn btn-success btn-smll" data-toggle="modal" data-target="#add_user">เพิ่มข้อมูล<i class="bi bi-plus"></i></button>
                            </div>
                        </div>
                            <div class="card-body">
                                ...
                                <table width="100%" class="table thead-dark table-hover table-bordered table-striped dt-responsive nowrap" id="myTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo number_format( $r["BMI"], 2 ); ?></td>
    ...
    <!-- Add User Modal -->
    <div class="modal fade show" id="add_user" tabindex="-1" aria-hidden="true" >
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <form method="post" action="am_user_save.php">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div class="form-group row">
								<div class="col-sm-6">
									...
									<input type="text" required name="fname" id="fname" class="form-control form-control-user" placeholder="โปรดกรอก" autocomplete="off">
								</div>
                                <div class="col-sm-6">
                                    <label for="lname" class="col-sm-12 form-control-label" style="color:black" >Last name - นามสกุล</label></br>
									<input type="text" required name="lname" id="lname" class="form-control form-control-user" placeholder="โปรดกรอก" autocomplete="off">
								</div>
							</div>
                            ...
                            <div class="form-group row">
								<div class="col-sm-12">
									...
									<input type="email" required name="email" id="email" class="form-control form-control-user"  placeholder="โปรดกรอก">
								</div>
							</div>
                            ...
                            <div class="form-group row">
								...
								<div class="col-sm-6">
									...
									<input type="int" required name="idcard" id="idcard" class="form-control form-control-user"  placeholder="โปรดกรอก" maxlength="13" autocomplete="off">
								</div>
                                <div class="col-sm-6">
                                    <label for="tel" class="col-sm-12 form-control-label" style="color:black" >เบอร์โทรศัพท์</label></br>
									<input type="text" required name="tel" id="tel" class="form-control form-control-user"  placeholder="โปรดกรอก" maxlength="10" autocomplete="off">
								</div>
							</div>
                            ...
                            <div class="form-group row">
								...
								<div class="col-sm-6">
									...
									<input type="date" required name="birthday" id="birthday" class="form-control form-control-user">
								</div>

                            <div class="col-sm-6">
                                <label for="sex" class="col-sm-8 form-control-label" style="color:black" >Sex - เพศ</label></br>
                                <select id="sex" name="sex" class="form-control form-control-user">
                            ...
                            <div class="form-group row">
								...
								<div class="col-sm-3">
									...
									<input type="number" required name="weight" id="weight" class="form-control form-control-user" placeholder="โปรดกรอก" autocomplete="off" min="1" max="300">
								</div>
                                <div class="col-sm-3">
                                    <label for="height" class="col-sm-12 form-control-label" style="color:black" >ส่วนสูง</label></br>
									<input type="number" required name="height" id="height" class="form-control form-control-user" placeholder="โปรดกรอก" autocomplete="off" min="1" max="300">
								</div>

                                <div class="col-sm-6">
                                    <label for="user_leve" class="col-sm-8 form-control-label" style="color:black" >ระดับผู้ใช้</label></br>
                                    <select id="levle" name="user_leve" class="form-control form-control-user">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12">
									...
									<input type="text" required name="province" list="province" class="form-control form-control-user" placeholder="โปรดกรอก" autocomplete="off">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12">
									...
									<input type="text" required name="hi" list="hi" class="form-control form-control-user" placeholder="โปรดกรอก" autocomplete="off">
                                <datalist id="hi">
                ...
                <form method="post" action="am_user_update.php">
                    <div class="modal-header">
                        ...
                        <div class="form-group row">
								<div class="col-sm-6">
                                    <label for="fname" class="col-sm-12 form-control-label" style="color:black" >First name - ชื่อ</label></br>
									<input type="text" required name="fname" id="efname" class="form-control form-control-user" placeholder="First name - ชื่อ" autocomplete="off">
								</div>
                                <div class="col-sm-6">
                                    <label for="lname" class="col-sm-12 form-control-label" style="color:black" >Last name - นามสกุล</label></br>
									<input type="text" required name="lname" id="elname" class="form-control form-control-user" placeholder="Last name - นามสกุล" autocomplete="off">
								</div>
							</div>
                            ...
                            <div class="form-group row">
								<div class="col-sm-12">
                                    <label for="email" class="col-sm-8 form-control-label" style="color:black" >Email address - อีเมล</label></br>
									<input type="email" required name="email" id="eemail" class="form-control form-control-user"  placeholder="Email address - อีเมล">
								</div>
							</div>
                            ...
                            <div class="form-group row">
								...
								<div class="col-sm-6">
                                    <label for="idcard" class="col-sm-10 form-control-label" style="color:black" >เลขบัตรประชาชน</label></br>
									<input type="int" required name="idcard" id="eidcard" class="form-control form-control-user"  placeholder="Citizen ID - เลขบัตรประชาชน" maxlength="13" autocomplete="off">
								</div>
                                <div class="col-sm-6">
                                    <label for="tel" class="col-sm-12 form-control-label" style="color:black" >เบอร์โทรศัพท์</label></br>
									<input type="text" required name="tel" id="etel" class="form-control form-control-user"  placeholder="Phone Number - เบอร์โทรศัพท์" maxlength="10" autocomplete="off">
								</div>
							</div>
                            ...
                            <div class="form-group row">
								...
								<div class="col-sm-3">
                                    <label for="weight" class="col-sm-12 form-control-label" style="color:black" >น้ำหนัก</label></br>
									<input type="number" required name="weight" id="eweight" class="form-control form-control-user" placeholder="Weight - น้ำหนัก" autocomplete="off" min="1" max="300">
								</div>
                                <div class="col-sm-3">
                                    <label for="height" class="col-sm-12 form-control-label" style="color:black" >ส่วนสูง</label></br>
									<input type="number" required name="height" id="eheight" class="form-control form-control-user" placeholder="Height - ส่วนสูง" autocomplete="off" min="1" max="300">
								</div>

                                <div class="col-sm-6">
                                    <label for="user_leve" class="col-sm-8 form-control-label" style="color:black" >ระดับผู้ใช้</label></br>
                                    <select id="elevle" name="user_leve" class="form-control form-control-user">
                                        <option value="u">ผู้ใช้ทั่วไป</option>
                                        <option value="a">ผู้ดูแลระบบ</option>
                                    </select>
                                </div>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12">
                                    <label for="province" class="col-sm-8 form-control-label" style="color:black" >Province - จังหวัด</label></br>
									<input type="text" required name="province" list="province" id="eprovince" class="form-control form-control-user" placeholder="Province - จังหวัด" autocomplete="off">
                                <datalist id="province">
                                        <option value='Bangkok - กรุงเทพมหานคร'>
                                        <option value='Kamphaeng Phet Province - จังหวัดกำแพงเพชร'>
                                        <option value='Chai Nat Province - จังหวัดชัยนาท'>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12">
                                    <label for="hi" class="col-sm-12 form-control-label" style="color:black" >Health Insurance - สิทธิประกันสุขภาพ</label></br>
									<input type="text" required name="hi" list="hi" id="ehi" class="form-control form-control-user" placeholder="Health Insurance - สิทธิประกันสุขภาพ" autocomplete="off">
                                <datalist id="hi">
                                    <option value='Not stated - ไม่ระบุ'> 
                                        <option value='WEL - สิทธิประกันสุขภาพถ้วนหน้า ประเภทมีสิทธิย่อย(WEL)'>
                                        <option value='UCS - สิทธิประกันสุขภาพถ้วนหน้า(UCS)'>
